  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-sm border border-border rounded-xl p-8 shadow-sm bg-card">
        <h1 className="text-2xl font-bold text-center mb-1 text-foreground">Entrar</h1>
        <p className="text-sm text-center text-muted-foreground mb-6">Acesse sua conta Cefet</p>
